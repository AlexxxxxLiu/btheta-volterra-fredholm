...
\cref{thm:finite-det,thm:whole-line-det}, together with
\cref{rem:nonzero-mean}, identify the determinants with the characteristic
functions of $X-\mathbb E X$, and characteristic functions determine
probability measures uniquely.  Thus probability-CDF centering
